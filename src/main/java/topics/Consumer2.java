...
public class Consumer2 {
    public static void main(String[] args) throws Exception{
        ...
        //创建队列
        channel.queueDeclare(ConnectUtil.TOPIC_QUEUE_2, true, false, false, null);
        //队列绑定交换机
        channel.queueBind(ConnectUtil.TOPIC_QUEUE_2, ConnectUtil.TOPIC_EXCHAGE, "item.*");
        //监听消息
         ...
         */
        channel.basicConsume(ConnectUtil.TOPIC_QUEUE_2, true, consumer);
